...
<form id="discuss-task-form" class="cta-form" action="{{ route('form.zapros') }}" method="POST">
  @csrf
  <x-form.timestamp />
  <div class="cta-field">
...
<p class="cta-note">Нажимая «Отправить», вы соглашаетесь с политикой конфиденциальности</p>
