        ...
        <div class="ph-inner pad_l0_important pad_r0_important ">
            <div class="ph-left">
                ...
                <div class="ph-left-pad">
                    ...
                    <h1 class="page-title">{!! $ms['hero_title'] ?? 'Многоуровневая программа подготовки переговорщиков <br>«<em>Программа подготовки переговорщиков для бизнеса</em>»' !!}</h1>
    ...
    <div class="page-wrap">
        <div class="main-col">
            ...
            <div class="about">
                ...
                {!! $ms['about_text'] ?? '<p>Любой бизнес начинается и заканчивается за столом переговоров. От того, кто сядет за этот стол, зависит не только сохранение ресурсов организации, но и возможно судьба самого бизнеса и его собственников.</p><p>Программа «Программа подготовки переговорщиков для бизнеса» — это поэтапный путь от базовых навыков делового общения до уровня опытного переговорщика, способного работать в жёстких условиях и управлять сложными коммуникациями любого уровня.</p>' !!}
