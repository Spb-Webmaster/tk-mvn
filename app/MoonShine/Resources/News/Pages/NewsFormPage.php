                            ...
                            Column::make([
                                ...
                                Collapse::make('Видео', [
                                    Json::make('', 'video')->fields([
                                        ...
                                        Image::make('Постер', 'poster')
                                            ->disk('public')
                                            ->dir('content/news/video/posters')
                                            ->allowedExtensions(['jpg', 'png', 'jpeg', 'gif', 'svg'])
                                            ->removable(),
                                        File::make('Файл', 'file')
                                            ->disk('public')
                                            ->dir('content/news/video')
                                            ->accept('video/*')
                                            ->removable(),
                                ...
                                Collapse::make('Файлы', [
                                    Json::make('', 'files')->fields([
                                        ...
                                        File::make('', 'file')
                                            ->disk('public')
                                            ->dir('content/news/files')
                                            ->customName(fn(UploadedFile $file) => FileNaming::deduplicate($file, 'content/news/files'))
                                            ->hint('Файл'),
