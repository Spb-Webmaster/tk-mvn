...
/**
 * @extends FormPage<ResponseResource>
 */
final class ResponseFormPage extends FormPage
{
    /**
                    ...
                    Tab::make('Основное', [
                        ...
                        Grid::make([
                            Column::make([
                                ...
                                TinyMce::make('Текст отзыва', 'short_desc'),
                            ])->columnSpan(9),
                            ...
                            Column::make([
                                Box::make([
                                    ...
                                    BelongsToMany::make('Категории', 'categories', resource: ResponseCategoryResource::class)
                                        ->selectMode()
                                        ->searchable(),
                                ]),
                            ])->columnSpan(3),
                            ...
                            Column::make([
                                ...
                                Collapse::make('Файлы', [
                                    Json::make('', 'files')->fields([
                                        ...
                                        File::make('', 'file')
                                            ->disk('public')
                                            ->dir('content/responses/files')
                                            ->customName(fn(UploadedFile $file) => FileNaming::deduplicate($file, 'content/responses/files'))
                                            ->hint('Файл'),
